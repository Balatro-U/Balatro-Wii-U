...
function Card:generate_UIBox_ability_table()
    ...
    if self.sticker or (self.sticker_run and self.sticker_run~='NONE')  then loc_vars = loc_vars or {}; loc_vars.sticker=(self.sticker or self.sticker_run) end
                ...
                G.E_MANAGER:add_event(Event({func = function()
                    ...
                    if ffi then
                        ...
                        if card.base.id < 10 then
                            if ffi then
                                rank_suffix = tostring(card.base.id)
                            end
                        elseif card.base.id == 10 then
                            if ffi then
                                rank_suffix = 'T'
                            end
                        elseif card.base.id == 11 then
                            if ffi then
                                rank_suffix = 'J'
                            end
                        ...
                        elseif card.base.id == 13 then
                            if ffi then
                                rank_suffix = 'K'
                            end
                        elseif card.base.id == 14 then
                            if ffi then
                                rank_suffix = 'A'
                            end
                        end
    ...
    if (layer == 'card' or layer == 'both') then
        ...
        elseif self.sprite_facing == 'front' then 
            ...
            if self.edition or self.seal or self.ability.eternal or self.ability.rental or self.ability.perishable or self.sticker or ((self.sticker_run and self.sticker_run ~= 'NONE') and G.SETTINGS.run_stake_stickers) or (self.ability.set == 'Spectral') or self.debuff or self.greyed or (self.ability.name == 'The Soul') or (self.ability.set == 'Voucher') or (self.ability.set == 'Booster') or self.config.center.soul_pos or self.config.center.demo then
                ...
                elseif self.sticker_run and G.shared_stickers[self.sticker_run] then
