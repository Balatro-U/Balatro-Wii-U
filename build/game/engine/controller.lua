...
function Controller:set_gamepad(_gamepad)
    if self.GAMEPAD.object ~= _gamepad then 
        ...
        if _gamepad.getGamepadMappingString then
            self.GAMEPAD.mapping = _gamepad:getGamepadMappingString() or ''
        else
            self.GAMEPAD.mapping = ''
        end
...
function Controller:update_axis(dt)
    ...
    if self.HID.controller and self.GAMEPAD.object and self.GAMEPAD.object.getGamepadAxis then 
        ---------------------------------------------------------------
        --                     Left Thumbstick
        ---------------------------------------------------------------
