...
function boot_timer(_label, _next, progress)
  ...
  -- Debug: check what's available in love table
  print("DEBUG: love type:", type(love))
  if love then
    print("DEBUG: love.graphics type:", type(love.graphics))
    for k, v in pairs(love) do
      print("DEBUG: love." .. k .. " = " .. type(v))
    end
  else
    print("DEBUG: love is nil!")
  end
  
  G.LOADING = G.LOADING or {
    font = love.graphics and love.graphics.setNewFont("resources/fonts/m6x11plus.ttf", 20) or nil
  }
  ...
  if love.graphics then
    ...
    print("DEBUG: love.graphics is nil, skipping rendering")
  end

  G.ARGS.bt = G.ARGS.bt or (love.timer and love.timer.getTime() or 0)
  G.ARGS.bt = love.timer and love.timer.getTime() or 0
end
